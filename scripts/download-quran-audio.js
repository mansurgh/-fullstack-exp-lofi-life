...
const MAX_CONCURRENT_DOWNLOADS = 5; // Ограничиваем количество одновременных загрузок
...
async function downloadQuranAudio() {
  console.log('🚀 Starting Quran audio download...');
  ...
  async function downloadFromQueue() {
    ...
    setTimeout(downloadFromQueue, 100); // Небольшая задержка между загрузками
  }
