...
// Основная функция
async function main() {
  console.log('🚀 Автоматически исправляем и дополняем тексты Корана...\n');
...
`;
  ...
  console.log(`\n✅ Готово! Файл исправлен и сохранен: ${outputPath}`);
  console.log('📝 Теперь все суры 1-10 содержат полные тексты без ошибок');
