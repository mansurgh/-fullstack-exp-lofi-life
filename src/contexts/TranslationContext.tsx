...
const translations = {
  en: {
    ...
    'help.paypal.instructions': 'Copy the email and send your donation via PayPal app or website',
    'help.phone': 'Phone',
  ...
  ru: {
    // Navigation & General
    'app.title': 'Исламские Lofi Комнаты',
    'nav.rooms': 'Комнаты',
    'nav.quran': 'Коран',
    'nav.help': 'Помощь',
    ...
    'main.message': 'Ассаламу алейкум ва рахматуллахи ва баракатух, дорогие братья и сёстры, у меня не так много знаний в создании сайтов, и у меня нет необходимых денег для инвестирования в мои планы. Поэтому я хотел бы вашей помощи, если вам нравится концепция, которую вы видите перед собой. Я не знаю, как заставить это работать, но мои намерения - привлечь больше мусульман, которые могут просто расслабиться и слушать, изучать или читать Коран в lofi стиле для более спокойных людей. Для людей, которые любят природу, знания и спокойствие ума. Поэтому, пожалуйста, не стесняйтесь помочь мне или использовать мой сайт в полной мере. Пусть Аллах облегчит это для всех вас и пусть Аллах вознаградит всех вас, тем не менее.',
    ...
    'help.paypal.instructions': 'Скопируйте email и отправьте пожертвование через PayPal приложение или сайт',
    'help.phone': 'Телефон',
