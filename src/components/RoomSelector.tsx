...
const roomCategories: Record<string, FilterCategory> = {
  ...
  'rainy-study': 'places',
  'sunny-garden': 'places',
  'fireplace-nook': 'places',
  'moonlit-corner': 'places',
  'tuscan-vista': 'places',
  'alpine-retreat': 'places',
  'woodland-haven': 'places',
  'spongebob-pineapple': 'hobbies',
  'minecraft-room': 'hobbies',
  'pink-candy': 'places',
  'pirate-deck-view': 'hobbies',
  'naruto-room': 'hobbies',
  'ghibli-forest': 'places',
  'titan-wall': 'hobbies',
  'demon-slayer-dojo': 'hobbies',
  'hero-academy': 'hobbies',
  'dragon-ball-training': 'hobbies',
  'bird-shop': 'places',
  'room-with-cat': 'places',
  'cat-eating': 'places',
  'dog-eating': 'places',
