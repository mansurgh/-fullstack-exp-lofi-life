        ...
        {loading ? (
          ...
          <div className="p-6 overflow-y-auto flex-1 min-h-0">
            ...
            <div
              ...
              style={{ fontSize: `${fontSize + 4}px`, lineHeight: 2.2, whiteSpace: 'normal', overflowWrap: 'break-word', hyphens: 'auto' }}
              dir="rtl"
            >
            ...
            {showTransliteration && (
              <>
                <div
                  className="mb-4 text-muted-foreground italic leading-relaxed text-justify"
                  style={{ fontSize: `${fontSize}px`, whiteSpace: 'normal', overflowWrap: 'break-word', hyphens: 'auto' }}
                >
            ...
            {/* Translation */}
            <div
              className="mb-6 leading-relaxed text-foreground text-justify"
              style={{ fontSize: `${fontSize}px`, whiteSpace: 'normal', overflowWrap: 'break-word', hyphens: 'auto' }}
            >
