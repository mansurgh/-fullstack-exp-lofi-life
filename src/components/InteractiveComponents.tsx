...
const ClockWidget = React.memo(({ position, isDragging, onMouseDown, onTouchStart }: {
  position: Position;
  isDragging: boolean;
...
export const InteractiveComponents = ({ roomId }: InteractiveComponentsProps) => {
  ...
  const handleTouchStart = (e: React.TouchEvent, componentId: string, currentPosition: Position) => {
